# Betterbird-appimage
Unofficial AppImages built on top of the official portable build, Betterbird is a fine-tuned version of Mozilla Thunderbird, a free and open-source email client. 
