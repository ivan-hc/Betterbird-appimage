...
# CREATE BETTERBIRD BROWSER APPIMAGES
...
Keywords=Email;E-mail;Newsgroup;Feed;RSS;Thunderbird
Keywords[ast]=Corréu;Corréu-e;Noticies;Discusiones;Mensaxes;Canales;RSS;Thunderbird
Keywords[ca]=Correu;Email;E-mail;Mailing;Llistes;Notícies;RSS;Thunderbird
Keywords[cs]=Email;E-mail;Pošta;Elektronická pošta;Diskusní skupiny;Čtečka;RSS;Thunderbird
Keywords[da]=Email;E-mail;Epost;E-post;E-brev;Newsgroup;Nyhedsgruppe;Nyhedskilde;Usenet;Feed;RSS;Thunderbird
Keywords[de]=Mail;E-Mail;Newsgroup;Nachrichten;Feed;RSS;Post;News;Usenet;online;lesen;schreiben;Thunderbird
Keywords[el]=Email;E-mail;Newsgroup;Feed;RSS;ημαιλ;Αλληλογραφία;Ροή;ΡΣΣ;Συζητήσεις;Γράμματα;Thunderbird
Keywords[es_ES]=Email;Correo electrónico;Noticias;Discusiones;Mensajes;Canales;RSS;Thunderbird
Keywords[es_AR]=Email;Correo electrónico;Noticias;Discusiones;Mensajes;Canales;RSS;Thunderbird
Keywords[fi]=Mail;E-Mail;Email;Newsgroup;Feed;RSS;posti;sähköposti;maili;meili;Usenet;uutisryhmät;syöte;Thunderbird
Keywords[fr]=Mails;Mels;E-Mails;Emails;Courriels;Courriers;Newsgroup;Feed;RSS;Poster;Betterbird;Lire;Écrire;Thunderbird
Keywords[he]=דואל;דוא״ל;מייל;אי-מייל;אימייל;הודעות;מוזילה;תאנדרבירד;ת׳אנדרבירד;ת'אנדרבירד;ת׳אנדרברד;ת'אנדרברד;דואל;Thunderbird
Keywords[hr]=email;e-mail;e-pošta;pošta;RSS;Thunderbird
Keywords[hu]=Email;E-mail;Levél;Levelezés;Hírcsoport;Feed;Hírforrás;RSS;Thunderbird
Keywords[it]=Email;Mail;Posta;Newsgroup;Feed;RSS;Thunderbird
Keywords[ja]=Eメール;イーメール;mail;e-mail;email;メール;電子メール;ニュースグループ;ネットニュース;RSS;フィードリーダー;書く;読む;Thunderbird
Keywords[nl]=Email;E-mail;Newsgroup;Feed;RSS;Nieuwsgroep;Post;Thunderbird
Keywords[ru]=Email;E-mail;Newsgroup;Feed;RSS;почта;письма;новости;фиды;Thunderbird
Keywords[sk]=Email;E-mail;Elektronická pošta;Diskusné skupiny;Čítačka kanálov;RSS;Thunderbird
Keywords[uk]=Email;E-mail;Newsgroup;Feed;RSS;пошта;новини;подачі;стрічка;Thunderbird
Keywords[vi]=Mail;E-Mail;Email;Newsgroup;Feed;RSS;Thư điện tử;Gửi thư;Thunderbird
Keywords[zh_CN]=Mail;E-Mail;Email;Newsgroup;Feed;RSS;电子;邮件;新闻;雷鸟;电邮;邮箱;阅读器;Thunderbird
...
_create_betterbird_appimage() {
	...
	# Extract the archive
	[ -e ./*tar.* ] && tar fx ./*tar.* && mv ./betterbird/* "$APP".AppDir/ && rm -f ./*tar.* || exit 1

	# Enter the AppDir
	cd "$APP".AppDir || exit 1

	# Add the launcher and patch it depending on the release channel
	echo "$LAUNCHER" > betterbird.desktop

	# Add the icon
	cp ./chrome/icons/default/default128.png betterbird.png
	cd .. || exit 1
	...
	ARCH=x86_64 ./appimagetool -u "gh-releases-zsync|$GITHUB_REPOSITORY_OWNER|Betterbird-appimage|continuous-$CHANNEL|*-$CHANNEL-*x86_64.AppImage.zsync" \
		./"$APP".AppDir Betterbird-"$CHANNEL"-"$VERSION"-x86_64.AppImage || exit 1
}
